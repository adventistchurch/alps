...
export const primaryColorsThemes = [
  { name: 'Off', class: 'theme-fb', value: '#' },
  { name: 'Bluejay', class: 'u-theme--bluejay', value: '#2e6de7' },
  { name: 'Campfire', class: 'u-theme--campfire', value: '#cd4900' },
  { name: 'Cave', class: 'u-theme--cave', value: '#255760' },
  { name: 'Denim', class: 'u-theme--denim', value: '#2f557f' },
  { name: 'Earth', class: 'u-theme--earth', value: '#5e3929' },
  { name: 'Emperor', class: 'u-theme--emperor', value: '#4b207f' },
  { name: 'Forest', class: 'u-theme--forest', value: '#355724' },
  { name: 'Grapevine', class: 'u-theme--grapevine', value: '#712551' },
  { name: 'Lily', class: 'u-theme--lily', value: '#d41583' },
  { name: 'Ming', class: 'u-theme--ming', value: '#007f98' },
  { name: 'Night', class: 'u-theme--night', value: '#4a4a4a' },
  { name: 'Scarlett', class: 'u-theme--scarlett', value: '#d0021b' },
  { name: 'Treefrog', class: 'u-theme--treefrog', value: '#2b8500' },
  { name: 'Velvet', class: 'u-theme--velvet', value: '#782832' },
  { name: 'Winter', class: 'u-theme--winter', value: '#717171' },
]
