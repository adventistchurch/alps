...
Our colors consist of 2 primary sets, 8 Bright Colors and 8 Muted Colors. The Bright and Muted colors have 5 Extended Colors with each color, a Base color with a Dark, Darker, Light and Lighter color.
