...
"comments" : [
	...
	// 	"el": ".carousel",
	// 	"title" : "Carousel",
	// 	"comment": "<p>Carousels are defined by their use of full-width background imagery and vertically centered content, with equal padding above and below the content. We use carousel organisms to bring our core to a user's attention.</p>"
	// },
	// {
	// 	"el": "#product-img nav",
